  ...
  return (
    <div className='text-blue-900'>
      ...
      <div className='p-8 text-center'>
        <h2 className='font-semibold text-xl tracking-wide'>SKILLS</h2>
          ...
          <div className='text-left md:w-4/12'>
            ...
            <ul className='list-disc'>
              <li className='my-4'>
                ...
                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam a metus ut erat ultricies pellentesque. Mauris orci ex, bibendum euismod ipsum eu, gravida vestibulum erat. Nullam quis commodo ante. Nunc sed nunc tempus, varius nisl at, eleifend dui.</p>
              ...
              <li className='my-4'>
                <p className='text-md font-semibold'>UI/UX Designer</p>
                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam a metus ut erat ultricies pellentesque. Mauris orci ex, bibendum euismod ipsum eu, gravida vestibulum erat. Nullam quis commodo ante. Nunc sed nunc tempus, varius nisl at, eleifend dui.</p>
              </li>
            </ul>
          </div>
          <div className='md:w-4/12 text-left md:mt-0 mt-4'>
            ...
            <ul className='list-disc'>
              <li className='my-4'>
                ...
                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam a metus ut erat ultricies pellentesque. Mauris orci ex, bibendum euismod ipsum eu, gravida vestibulum erat.</p>
              </li>
              <li className='my-4'>
              ...
              <li className='my-4'>
                <p className='text-md font-semibold'>Passionate</p>
                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam a metus ut erat ultricies pellentesque. Mauris orci ex, bibendum euismod ipsum eu, gravida vestibulum erat.</p>
              </li>
              <li className='my-4'>
              ...
              <li className='my-4'>
                <p className='text-md font-semibold'>Flexible</p>
                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam a metus ut erat ultricies pellentesque. Mauris orci ex, bibendum euismod ipsum eu, gravida vestibulum erat.</p>
              </li>
            </ul>
          </div>
      ...
      <div className='p-8 md:text-center'>
        <h2 className='font-semibold text-xl tracking-wide text-center'>EDUCATION</h2>
        <ul>
          <li className='my-4'>
      ...
      <div className='p-8 text-left'>
        <h2 className='font-semibold text-xl tracking-wide text-center'>EXPERIENCE</h2>
